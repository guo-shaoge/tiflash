...
// TODO hash?
using AggregatedDataWithShortStringKey = HashMapWithSavedHash<StringRef, AggregateDataPtr>;
...
using AggregatedDataWithShortStringKeyTwoLevel = TwoLevelHashMapWithSavedHash<StringRef, AggregateDataPtr>;
