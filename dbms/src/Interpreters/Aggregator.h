...
using AggregatedDataWithKeys128 = HashMap<UInt128, AggregateDataPtr, Hash128WithSeed<PhHashSeed1>>;
...
using AggregatedDataWithKeys128TwoLevel = TwoLevelHashMap<UInt128, AggregateDataPtr, Hash128WithSeed<PhHashSeed1>>;
