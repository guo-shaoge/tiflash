...
struct StringHashTableHashRefine
{
...
template <typename TMapped, typename Allocator>
struct StringHashMapSubMapsRefine
{
    static constexpr bool isPhMap = false;
    static constexpr bool isNestedMap = true;

    using T0 = StringHashTableEmpty<StringHashMapCell<StringRef, TMapped, StringHashTableHashRefine>>;
    using T1 = HashMapTable<
        StringKey8,
        StringHashMapCell<StringKey8, TMapped, StringHashTableHashRefine>,
        StringHashTableHashRefine,
        StringHashTableGrower<>,
        Allocator>;
    using T2 = HashMapTable<
        StringKey16,
        StringHashMapCell<StringKey16, TMapped, StringHashTableHashRefine>,
        StringHashTableHashRefine,
        StringHashTableGrower<>,
        Allocator>;
    using T3 = HashMapTable<
        StringKey24,
        StringHashMapCell<StringKey24, TMapped, StringHashTableHashRefine>,
        StringHashTableHashRefine,
        StringHashTableGrower<>,
        Allocator>;
    using Ts = HashMapTable<
        StringRef,
        StringHashMapCell<StringRef, TMapped, StringHashTableHashRefine>,
        StringHashTableHashRefine,
        StringHashTableGrower<>,
        Allocator>;
};
...
template <
    typename TMapped,
    typename Allocator = HashTableAllocator,
    template <typename, typename> typename TSubMaps = StringHashMapSubMapsRefine>
class StringHashMapRefine : public StringHashTable<TSubMaps<TMapped, Allocator>>
{
public:
    using Key = StringRef;
    using Base = StringHashTable<StringHashMapSubMapsRefine<TMapped, Allocator>>;
    using Self = StringHashMapRefine;
...
template <
    typename TMapped,
    typename Allocator = HashTableAllocator,
    template <typename, typename, template <typename, typename> typename> typename ImplTable = StringHashMapRefine,
    template <typename, typename> typename SubMaps = StringHashMapSubMapsRefine>
class TwoLevelStringHashMapRefine
    : public TwoLevelStringHashTable<SubMaps<TMapped, Allocator>, ImplTable<TMapped, Allocator, SubMaps>>
{
public:
    using Key = StringRef;
    using Self = TwoLevelStringHashMapRefine;
