...
public:
    ...
    void stopAndInitConvergent()
    {
        stop();
        init_convergent += elapsed();
    }
    UInt64 getInitConvergent() const { return init_convergent; }
    void addInitConvergent(UInt64 tmp)
    {
        init_convergent += tmp;
    }
